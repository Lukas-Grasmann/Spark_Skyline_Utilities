...
datasets_complete=("store_sales")
datasets_incomplete=("store_sales_incomplete")

num_dimensions=$(seq 1 6)
num_nodes=$(seq 5 5)

declare -A dimensions
dimensions[store_sales]="ss_quantity ss_wholesale_cost ss_list_price ss_sales_price ss_ext_discount_amt ss_ext_sales_price"

dimensions[store_sales_incomplete]="ss_quantity ss_wholesale_cost ss_list_price ss_sales_price ss_ext_discount_amt ss_ext_sales_price"

declare -a minmaxdiff
minmaxdiff[store_sales]="MAX MIN MIN MIN MAX MIN"

minmaxdiff[store_sales_incomplete]="MAX MIN MIN MIN MAX MIN"

declare -A tuples
tuples[store_sales]=1000

tuples[store_sales_incomplete]=1000
