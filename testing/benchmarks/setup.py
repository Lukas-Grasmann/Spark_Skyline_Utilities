...
input_home = "/input-home/benchmarks/input/data/"       # terminate directory path by '/'
...
store_sales_incomplete_source ="store_sales_incomplete.csv"
...
try:
    ...
    sqlContext.sql("CREATE TABLE benchmarks.airbnb AS SELECT * FROM airbnb");
...
try:
    ...
    sqlContext.sql("CREATE TABLE benchmarks.fueleconomy AS SELECT * FROM fueleconomy");
except AnalysisException as e:
    # skip file
...
try:
    ...
    sqlContext.sql("CREATE TABLE benchmarks.coil2000 AS SELECT * FROM coil2000");
except AnalysisException as e:
    # skip file
...
try:
    ...
    sqlContext.sql("CREATE TABLE benchmarks.nba AS SELECT * FROM nba");
except AnalysisException as e:
    # skip file
...
try:
    df_store_sales = sqlContext.read.format('csv').options(header='true', inferschema='true').load(input_home + store_sales_source)
    df_store_sales.registerTempTable("store_sales")
    sqlContext.sql("CREATE TABLE benchmarks.store_sales AS SELECT * FROM store_sales");
except AnalysisException as e:
    # skip file
    print("Synthetic (store sales) input file does not exist.")
    print(e)
...
try:
    ...
    sqlContext.sql("CREATE TABLE benchmarks.airbnb_incomplete AS SELECT * FROM airbnb_incomplete");
except AnalysisException as e:
    # skip file
...
try:
    ...
    sqlContext.sql("CREATE TABLE benchmarks.fueleconomy_incomplete AS SELECT * FROM fueleconomy_incomplete");
except AnalysisException as e:
    # skip file
...
try:
    ...
    sqlContext.sql("CREATE TABLE benchmarks.coil2000_incomplete AS SELECT * FROM coil2000_incomplete");
except AnalysisException as e:
    # skip file
...
try:
    ...
    sqlContext.sql("CREATE TABLE benchmarks.nba_incomplete AS SELECT * FROM nba_incomplete");
except AnalysisException as e:
    # skip file
...
try:
    ...
    sqlContext.sql("CREATE TABLE benchmarks.store_sales_incomplete AS SELECT * FROM store_sales_incomplete");
except AnalysisException as e:
    # skip file
