...
do
    ...
    do
        filename=reference-${dataset}-${tuples[${dataset}]}t-${dimension}d-4n.sql
...
do
    ...
    do
        ...
        do
            ...
            filename=${algorithm}-${dataset}-${tuples[${dataset}]}t-${dimension}d-4n.sql
            creation_path=${destination_folder}/${filename}
            absolute_path=$(realpath ${creation_path})
...
do
    for dimension in ${num_dimensions[@]}
    do
        filename=dist_inc-${dataset}-${tuples[${dataset}]}t-${dimension}d-4n.sql
        creation_path=${destination_folder}/${filename}
        absolute_path=$(realpath ${creation_path})
